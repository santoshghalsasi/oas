...
[![Build Status](https://travis-ci.org/APIs.guru/PetStore.svg?branch=master)](https://travis-ci.org/APIs.guru/PetStore)
...
6. If you did everything correct, https://apis.guru.github.io/PetStore/ will lead to your new docs
...
- Documentation(ReDoc): https://apis.guru.github.io/PetStore/
- SwaggerUI: https://apis.guru.github.io/PetStore/swagger-ui/
- Look full spec:
    + JSON https://apis.guru.github.io/PetStore/swagger.json
    + YAML https://apis.guru.github.io/PetStore/swagger.yaml
- Preview spec version for branch `[branch]`: https://apis.guru.github.io/PetStore/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://apis.guru.github.io/PetStore/ with url from the message: `Server started <url>`
